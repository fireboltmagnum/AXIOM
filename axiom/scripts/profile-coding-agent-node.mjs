...
const agentDirEnvName = "AXIOM_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "AXIOM_STARTUP_BENCHMARK";
...
Options:
  ...
  --no-offline           Do not force AXIOM_OFFLINE=1 / AXIOM_SKIP_VERSION_CHECK=1
...
function createBenchmarkEnv(options, isolatedAgentDir) {
	...
	if (options.offline) {
		env.AXIOM_OFFLINE = "1";
		env.AXIOM_SKIP_VERSION_CHECK = "1";
	}
	return env;
}
