import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@axiom/coding-agent";
import type { Component, EditorTheme, TUI } from "@axiom/tui";
import { truncateToWidth, visibleWidth } from "@axiom/tui";
