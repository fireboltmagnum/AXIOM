...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@axiom/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@axiom/tui";
