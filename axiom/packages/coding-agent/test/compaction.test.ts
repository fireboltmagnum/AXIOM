...
describe("shouldCompact", () => {
	it("should return true when context exceeds the model-aware threshold", () => {
		...
		expect(getCompactionTriggerTokens(100000, settings)).toBe(81000);
		expect(shouldCompact(95000, 100000, settings)).toBe(true);
		expect(shouldCompact(81000, 100000, settings)).toBe(false);
		expect(shouldCompact(81001, 100000, settings)).toBe(true);
	});

	it("should honor a custom threshold ratio", () => {
		const settings: CompactionSettings = {
			enabled: true,
			reserveTokens: 10000,
			keepRecentTokens: 20000,
		...
		expect(getCompactionTriggerTokens(100000, settings)).toBe(72000);
		expect(shouldCompact(72000, 100000, settings)).toBe(false);
		expect(shouldCompact(72001, 100000, settings)).toBe(true);
	});
