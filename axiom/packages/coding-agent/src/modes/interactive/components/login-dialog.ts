import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@axiom/ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@axiom/tui";
