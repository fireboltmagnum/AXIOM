import { type AgentMessage, uuidv7 } from "@axiom/agent-core";
 ...
 * Encodes cwd into a safe directory name under ~/.axiom/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.axiom/agent/sessions/<encoded-cwd>/).
	 */
