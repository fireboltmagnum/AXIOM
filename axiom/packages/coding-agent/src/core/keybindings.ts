...
export const KEYBINDINGS = {
	...
	"app.axiom.effort.cycle": {
		defaultKeys: "shift+tab",
		description: "Cycle AXIOM effort profile",
	},
...
const KEYBINDING_NAME_MIGRATIONS = {
	...
	cycleAxiomEffort: "app.axiom.effort.cycle",
