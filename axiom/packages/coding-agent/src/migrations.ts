...
/**
 * Migrate sessions from ~/.axiom/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.axiom/agent/ instead of
 * ~/.axiom/agent/sessions/<encoded-cwd>/. This migration moves them
