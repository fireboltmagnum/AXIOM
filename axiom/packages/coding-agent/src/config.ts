...
export function getPackageDir(): string {
	...
	const envDir = process.env.AXIOM_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json axiomConfig)
// =============================================================================
...
const axiomConfigName: string | undefined = pkg.axiomConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@axiom/coding-agent";
export const APP_NAME: string = axiomConfigName || "axiom";
export const APP_TITLE: string = axiomConfigName ? APP_NAME : "axiom";
export const CONFIG_DIR_NAME: string = pkg.axiomConfig?.configDir || ".axiom";
...
/**
 * Get the share viewer URL for a gist ID. AXIOM does not ship a hosted viewer,
 * so callers must set AXIOM_SHARE_VIEWER_URL to a base URL to enable /share.
 * Without it, this returns the raw gist URL as a graceful fallback so /share
 * still surfaces *something* clickable.
 */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.AXIOM_SHARE_VIEWER_URL;
