import { Markdown, type MarkdownTheme } from "@axiom/tui";
...
Options:
  -l, --local    Install project-locally (.axiom/settings.json)
...
Options:
  -l, --local    Remove from project settings (.axiom/settings.json)
