...
Discovery rules:
- In `~/.axiom/agent/skills/` and `.axiom/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.axiom/settings.json`:
