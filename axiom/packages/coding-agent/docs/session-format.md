...
```
~/.axiom/agent/sessions/--<path>--/<timestamp>_<uuid>.jsonl
```
...
For TypeScript definitions in your project, inspect `node_modules/@axiom/coding-agent/dist/` and `node_modules/@axiom/ai/dist/`.
