...
npm uninstall -g @axiom/coding-agent

# pnpm
pnpm remove -g @axiom/coding-agent

# Yarn
yarn global remove @axiom/coding-agent

# Bun
bun uninstall -g @axiom/coding-agent
```

Uninstalling pi leaves settings, credentials, sessions, and installed pi packages in `~/.axiom/agent/`.
...
Use `/model` or Ctrl+L to choose a model. Use Tab to cycle thinking level and Shift+Tab to cycle AXIOM effort. Use Ctrl+P / Shift+Ctrl+P to cycle through scoped models.
