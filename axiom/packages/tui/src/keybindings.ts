...
export const TUI_KEYBINDINGS = {
	...
	"tui.input.newLine": {
		// Shift+Enter is the canonical binding, but it only works on terminals that
		// support the kitty keyboard protocol or xterm modifyOtherKeys (iTerm2,
		// kitty, wezterm, ghostty, modern tmux). On terminals that don't (e.g.
		// macOS Terminal.app, basic SSH sessions), Shift+Enter is indistinguishable
		// from Enter at the byte level. Ctrl+J always sends a raw LF and Alt+Enter
		// sends ESC+CR, so those are reliable cross-terminal fallbacks.
		defaultKeys: ["shift+enter", "ctrl+j", "alt+enter"],
		description: "Insert newline (Shift+Enter, Ctrl+J, or Alt+Enter)",
	},
